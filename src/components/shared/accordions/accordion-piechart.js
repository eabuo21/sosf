...
const PieAccordion = ({ data, colors, centerImageSrc }) => {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 h-[fixed] p-2 md:flex md:flex-row-reverse md:pr-9 md:gap-2 w-full">
      <div className="w-full h-[fixed] md:w-[600px] md:h-[fixed] px-8">
        {data.map((item) => (
