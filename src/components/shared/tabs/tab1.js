        ...
        {tabs.map((tab) => (
          ...
          >
            ...
            >
              ...
              <article className="pt-6 ">{tab.content1}</article>

              <Link
                href={tab.link}
                className="hover-line w-[180px] pt-7 text-base"
              >
                {tab.linktext} &rarr;
              </Link>
            </motion.section>
            ...
            <motion.section
              key={`image-${activeTab}`}
              className="h-[500px] w-full md:w-[400px] lg:w-[600px] pt-8 md:pt-0 md:left-[2rem] lg:left-[4rem] md:relative"
